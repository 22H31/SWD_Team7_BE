...
namespace BE_Team7.Migrations
{
    ...
    [Migration("20250324140739_InitialCreate")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ad18d7c5-aafb-475e-9c2d-e7c3986e42d5",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "c2be16b1-1f02-4014-8c29-10d47226abf6",
                            Name = "StaffSale",
                            NormalizedName = "STAFFSALE"
                        },
                        new
                        {
                            Id = "e46ba7b7-565c-4459-821c-c6f2cd7a783f",
                            Name = "Staff",
                            NormalizedName = "STAFF"
                        },
                        new
                        {
                            Id = "f436e063-99a7-4453-8475-d5b0dea5ac14",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("BE_Team7.Models.OrderRefund", b =>
                {
                    b.HasOne("BE_Team7.Models.Order", "Order")
                        .WithOne("RefundInfo")
                        .HasForeignKey("BE_Team7.Models.OrderRefund", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
